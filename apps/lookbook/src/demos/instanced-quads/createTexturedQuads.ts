import {colorFromTextureByTexCoords, positionByInstancePosition, VertexObjectPool, VertexObjects} from '@spearwolf/twopoint5d';
...
const createMaterial = (texture: Texture, material = new NodeMaterial()) => {
  material.positionNode = positionByInstancePosition({scale: vec3(attribute('quadSize'), 1.0)});
