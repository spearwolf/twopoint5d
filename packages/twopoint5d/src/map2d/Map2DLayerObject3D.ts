...
export class Map2DLayerObject3D extends Group {
  #renderers: Set<IMap2DTileRenderer> = new Set();
  #map2dLayer: Map2DTileStreamer;
  ...
  set tileStreamer(map2dLayer: Map2DTileStreamer) {
  ...
  constructor(map2dLayer: Map2DTileStreamer = new Map2DTileStreamer()) {
    super();
    this.#map2dLayer = map2dLayer;
  }
